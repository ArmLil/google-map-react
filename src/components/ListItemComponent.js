	...
	function ListItemComponent(props) {
		...
		return (
			<ListItem
				...
				dense
				button
				onClick={() => props.handleListItemClick(props.elem)}
				>
				<IconButton className={classes.iconButton} 	style={{padding:0}} disabled>
					<LocationOn/>
				</IconButton>
				...
				<ListItemSecondaryAction>
					<IconButton
						...
						aria-label="Delete"
						onClick={() => props.clickHandler(props.elem, props.index)}
					>
						<DeleteIcon />
					</IconButton>
				</ListItemSecondaryAction>
